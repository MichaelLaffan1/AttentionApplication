...
class Statistics(FloatLayout):
    def __init__(self, user, **kwargs):
        ...
        self.current_label = Label(text=f'Current Span: 0.0 seconds', \
                                ...
                                size_hint_x=None, width=int(Window.width * 0.48))
        ...
        self.avg_label = Label(text=f'Average Span: 0.0 seconds', font_size='30sp', halign='left', size_hint_x=None, width=int(Window.width * 0.48))
        ...
        self.long_label = Label(text=f'Longest Span: 0.0 seconds', font_size='30sp', halign='left', size_hint_x=None, width=int(Window.width * 0.48))
        self.long_label.bind(size=self.long_label.setter('text_size'))

        self.long_notes = Label(text='No data', font_size='20sp')
        ...
        self.body = GridLayout(cols=2, row_force_default=True, \
                            row_default_height=int(Window.height * 0.146), pos_hint={'x':.05, 'y':-0.2})
        ...
        self.body.add_widget(Label(size_hint_x=None, width=int(Window.width * 0.48)))
